...
import { Users, Phone, Github, Briefcase, Newspaper, LifeBuoy } from "lucide-react";
...
const cardData = [
  {
    ...
    icon: Users,  
    title: "О нас",
    description: "Узнайте о нашей команде и проектах",
    label: "Информация",
    url: "/about",
  },
  {
  ...
  },
  {
    ...
    icon: Briefcase,
    title: "Портфолио",
    description: "Наши лучшие работы и кейсы",
    label: "Проекты",
    url: "/contact",
  },
  {
