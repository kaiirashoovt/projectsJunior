...
function UserProfile({ userId }) {
  ...
  useEffect(() => {
    async function fetchUser() {
      setLoading(true);
      try {
        const res = await fetch(`https://my-fastapi-backend-f4e2.onrender.com/api/users/${userId}`);
    ...
    <div className="">
      <header className="flex items-center space-x-6 mb-8">
        ...
        <button
          ...
          className="ml-auto px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 focus:outline-none"
